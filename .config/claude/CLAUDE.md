...
- subagentは `/review` でPRをレビューし、指摘を返す
...
許可なく不必要に単語を省略すると認知コストが上がる

### 不要な単語省略をしない

session内の会話において、許可なく不必要に単語を省略すると認知コストが上がる。一般語彙として十分に浸透している語句のみ省略単語を許容する。一般語彙として十分に浸透している語句のみ省略単語を許容する。
